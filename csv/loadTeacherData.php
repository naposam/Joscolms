...
<?php include ('controllerAuth.php');?>
    ...
    <div class="contanier" style="width:80%;background-color: rgba(0,0,0,0.5); box-shadow: 5px 5px 10px white; height: 500px!important;">
       ...
       <!--      <div class="col-md-6 col-sm-12 col-lg-6">
             <div class="contanier" style="width: 80%;background-color: rgba(0,0,0,0.7);box-shadow: 5px 5px 10px white; height: 400px;">
                <br>
                <h4 style="font-family: sans-serif;color: white;letter-spacing: 3px;">UPLOAD STUDENT DATA</h4>
                <img src="../img/st.png" width="150" height="150">
            <form action="" method="post" enctype="multipart/form-data">
            <br>
            <input type="file" name="file" class="form-control" style="width: 80%">
            <br>
            <button  type="submit" name="submit" class="btn btn-success" >Save Student Data</button>
            </form>
        </div>
    </div> -->
        
        <div class="col-md-12 col-sm-12 col-lg-12" >
            <div class="contanier" style="width: 40%;margin:0 auto!important;background-color: rgba(0,0,0,0.7);box-shadow: 5px 5px 10px white; height: 400px;">
                <br>
