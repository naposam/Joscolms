...
if($_POST['query'] != '')
{
  ...
  OR staff_id LIKE "%'.str_replace(' ', '%', $_POST['query']).'%"
  ';
}

$query .= 'ORDER BY tuid ASC ';
  ...
  foreach($result as $row)
  {
    ...
    <tr>
     <td>'.$a.'</td>
      ...
      <td><a href="records.php?id='.$row["tuid"].'"><i class="material-icons" data-toggle="tooltip" 
             title="Delete" style="color:darkorange;">&#xE872;</i><a/></td>
      <td><a href="update/teacherUpdate.php?pid='.$row["tuid"].'">
