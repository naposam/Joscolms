...
<?php include ('newcontrollerAuth.php');?>
    ...
    <div class="contanier" style="width:80%;background-color: rgba(0,0,0,0.5); box-shadow: 5px 5px 10px white; height: 500px!important;">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12">
             <div class="contanier" style="width: 40%;margin:0 auto;background-color: rgba(0,0,0,0.7);box-shadow: 5px 5px 10px white; height: 400px;">
                <br>
