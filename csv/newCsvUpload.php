...
class csv extends mysqli{
   ...
   public function import($file){
    ...
    while ($row= fgetcsv($file)){
     ...
     $value = "'".implode("','", $row)."'";
      $query ="INSERT INTO student_tbl(fname,mname,lname,gender,level,index_number,password,image,dept) VALUES(".$value.")";
      //echo $query;
      if($this->query($query)){
       $this->state_csv = true;
      }else{
...
if($this->state_csv){
   ...
   public function importData($file){
    ...
    while ($row= fgetcsv($file)){
     ...
     $value = "'".implode("','", $row)."'";
      $query ="INSERT INTO teacher_tbl(fname,mname,lname,gender,email,staff_id,image,dept,password) VALUES(".$value.")";
      //echo $query;
      if($this->query($query)){
       $this->state_csv = true;
      }else{
