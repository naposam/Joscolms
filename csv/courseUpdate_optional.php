<?php session_start();?>
<?php include ('update_optional.php');?>
...
<head >
    ...
    <title>manage Optional Courses</title>
                    ...
                    <div class="col-sm-12 col-lg-12 col-md-10">
                        <div class="registrationform">
                            <div class="form-horizontal">
                                    ...
                                    <legend><i class="glyphicon glyphicon-edit"></i>Edit Course</legend>
                                    ...
                                    <div class="form-group" id="divPassword">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                ...
                                                name="update" value="<?php echo $course;?>">
                                            </div>
                                    ...
                                    <div class="form-group" style="margin-top:10px; margin-right:-50px">
                                        <div class=" col-md-offset-4">
                                            <input type="submit" name="btnUpdate" id="btnLogin" class="btn btn-primary" value="Save Changes"  />
                                            <a href="optional_courses_list.php"   id="btnRegister" class="btn btn-warning" />Cancel</a>
                                        </button>
