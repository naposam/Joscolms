...
if(isset($_GET['pid'])){
    $pid=$_GET['pid'];
    $query="SELECT student_tbl.*,department_tbl.dept_name,level_tbl.level FROM student_tbl LEFT JOIN department_tbl ON student_tbl.dept=department_tbl.dept_id LEFT JOIN level_tbl ON student_tbl.level=level_tbl.lid  where student_tbl.suid='$pid'";
...
<head>
    ...
    <!-- Title Page-->
    <title>LMS Records Update</title>
            ...
            <?php if($row['account']=='1'):?> 
             ...
             <?php endif;?>
                ...
                <input type="hidden" name="user_id" value="<?php echo $row['tuid'];?>">
                        ...
                        <div class="form-row">
                            <div class="name">Index Number</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="email" value="<?php echo $row['index_number'];?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="level" value="<?php echo $row['level'];?>">
                                </div>
                            </div>
                        </div>
                      ...
                      <div class="form-row">
                        ...
                        <div>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="../records.php" style="color: red;">Exit</a>
                        </div>
