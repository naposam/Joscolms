        ...
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 ">
            ...
            <div class="box box-primary direct-chat direct-chat-primary">
                <div class="box-header with-border" style="background-color:#e2e2e2">
                    ...
                    if(isset($_GET['id'])){
                           $id=$_GET['id'];
                    $query="SELECT resources.*,coursetbl.course from resources left join coursetbl on resources.course=coursetbl.cid where re_id='$id' and uid='$uid' and resources.course='$course_ud'";
