...
VALUES('$ass_title','$image','$course_ud','$dept','$clid','$uid','$date','$time')";
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body" style="height: 100%; min-height: 514px; background-color: #e2e2e2">
                    <div class=" messagealert" id="del_container" >
                      <?php
                        $up="SELECT ass.*,option_tbl.course FROM ass LEFT JOIN option_tbl on ass.course=option_tbl.id where ass.email='$uid' and ass.course='$course_ud'";
