        ...
        <div class="container registrationform" style="height: 560px;border-radius: 5px;">
          <br><br><br><br>
                       ...
                       <div class="registrationform col-md-12 col-sm-12">
                          ...
                          <hr>
                          <?php 
                           $reg=mysqli_query($db,"SELECT course_reg.*,coursetbl.course FROM course_reg LEFT JOIN coursetbl ON course_reg.cid = coursetbl.cid WHERE course_reg.uid = '$uid'");
            ...
            if(isset($_POST['viewcourse'])){
              ...
              if($idCid !==""){
              $pView=mysqli_query($db,"SELECT course_reg.*,coursetbl.course FROM course_reg LEFT JOIN coursetbl ON course_reg.cid=coursetbl.cid where course_reg.cid='$idCid'");
