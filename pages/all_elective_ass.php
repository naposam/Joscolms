...
$viewreg=mysqli_query($db,"SELECT course_reg.*,coursetbl.course,level_tbl.level FROM course_reg left join coursetbl on course_reg.cid=coursetbl.cid left join level_tbl on course_reg.levelid=level_tbl.lid where course_reg.uid='$uid' and course_reg.deptid='$dept'");
		  ...
		  <div class="header" > 
            ...
            <form class="form-inline" method="POST">
               ...
               <div class="form-group mx-sm-3 mb-2">
                 <select class="form-control" name="assview" required="">
                              <option value="" <?php
                            if (!isset($_GET['assview']))
                                  echo "selected";
                            ?>>Select course to View Assignment</option>
                              <?php 
                                  while($view=mysqli_fetch_array($viewreg)){
                          ...
                          <input type="submit" name="viewbtn" class="btn btn-primary mb-2" value="View Assignment">
            ...
            <div id="page-inner" style=" min-height:700px!important;height: 300px!important">
              ...
              $course=$_POST['assview'];
$result1=mysqli_query($db,"SELECT ass_student.*,coursetbl.course as dcourse,student_tbl.fname,student_tbl.lname  FROM ass_student left join coursetbl
 on ass_student.course=coursetbl.cid left join student_tbl on ass_student.uid=student_tbl.suid where  ass_student.course='$course'");
                          $i=0; 
                         ...
                         <tr class="odd gradeX">
                           ...
                           <td><?php echo $row1['fname'].' '.$row1['lname'];?></td>
                            ...
                            <td><a href="../resources/<?php echo $row1["file_link"]?>" target="_blank">View/Download</a></td>
                            <td><?php echo $date;?></td>
                            <td><?php echo $time;?></td>
                            <td><?php echo "Submitted";?></td>
                             
                          <td><a href="all_elective_ass.php?id=<?php echo $row1['ass_id']?>"><i class="fa fa-trash" style="color: red;"></i></a></td>
                         </tr>
                     <?php
                     }
                     }
