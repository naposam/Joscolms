...
if(! isset($_SESSION['uid'])){
  ...
  $id=$_SESSION['uid'];
  $dataSet=mysqli_query($db,"SELECT teacher_tbl.*,department_tbl.dept_name FROM teacher_tbl LEFT JOIN department_tbl on teacher_tbl.dept=department_tbl.dept_id where teacher_tbl.tuid='$id'");
						...
						<div class="row">
							<form method="post" autocomplete="off">
							 ...
							 <input type="submit" name="add" class="btn btn-success" value="Update" disabled="">
								...
								<br>
								<input type="email" name="email" class="control" value="<?php echo $row['email'];?>">
								<br>
								<input type="text" name="staff" class="control" value="<?php echo $row['staff_id'];?>" readonly>
								<br>
