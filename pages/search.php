    ...
    <form id="form1" method="post" enctype="multipart/form-data">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <div class="coursecontent">
                ...
                <div class=" messagealert" id="success_container" >
                  ...
                  //   $name=
                  // }
                        $up="SELECT ass.*,coursetbl.course FROM ass LEFT JOIN coursetbl on ass.course=coursetbl.cid where ass.level='$levelID' and ass.course='$course' and thumb='Student'";
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
            <div class="panel panel-primary">
                ...
                <span>Search: <span><input type="search" name="search" class="form-control input-sm" placeholder="Search.......">
                <button class="btn btn-info btn-sm" type="submit" name="search">Search</button>
                </div>
