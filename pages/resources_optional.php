            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body" style="height: 100%; min-height: 514px; background-color: #e2e2e2">
                    ...
                    <div ID="dlCustomers"  OnItemCommand="Prev_command"
                        ...
                        $up="SELECT resources.*,option_tbl.course FROM resources left join option_tbl on resources.course=option_tbl.id where resources.uid='$uid' and resources.course='$course_ud'";
