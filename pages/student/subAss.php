...
$result1=mysqli_query($db,"SELECT ass_student.*,option_tbl.course as dcourse FROM ass_student left join option_tbl
 on ass_student.course=option_tbl.id where ass_student.uid='$uid' and ass_student.dept='$dept'");
...
if(isset($_GET['id'])){
 ...
 header("location: subAss.php?status=info");
}
...
<?php include ('index_sidebar.php');?>
		...
		<div id="page-wrapper" style=" min-height:500px!important;">
		  <div class="header" > 
                     ...
                     OPTIONAL COURSES SUBMITTED ASSIGNMENT
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
                   ...
                   <div class="card">
                    ...
                    <?php
                         ...
                         <tr class="odd gradeX">
                          ...
                          <td><a href="subAss.php?id=<?php echo $row1['ass_id']?>"><i class="fa fa-trash" style="color: red;"></i></a></td>
                         </tr>
                     <?php
                     }
                   ?>
