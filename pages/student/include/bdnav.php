                ...
                <div class="collapse navbar-collapse navbar-menubuilder">
                    <ul class="nav navbar-nav navbar-right">
                        <li ><a href="index.php"><i class="fa fa-home"></i>Home</a> </li>
                         <li><a href="course_reg.inc.php"><i class="fa fa-circle-o-notch fa-spin fa-1x fa-fw"></i>Course Registered</a> </li>
                        <li><a href="course_view.inc.php"><i class="fa fa-cog fa-spin fa-1x fa-fw"></i>Select Course</a> </li>
