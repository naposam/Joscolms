                         ...
                         <div id="pricePlans" style="overflow: hidden">
                             <ul id="plans">
                                 <li class="plan">
                                  ...
                                  $data = $db->query("SELECT resources.*,reg_opttbl.course_code,reg_opttbl.uid,option_tbl.course FROM `resources` left join reg_opttbl on resources.course=reg_opttbl.course_code left join option_tbl on reg_opttbl.course_code=option_tbl.id where resources.level='$levelID' and course_reg.uid='$userID' and course_reg.cid='$VID'");
        ...
        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 ">
            ...
            <div class="box box-primary direct-chat direct-chat-primary">
                <div class="box-header with-border" style="background-color:#e2e2e2">
                    ...
                    if(isset($_GET['id'])){
                           $id=$_GET['id'];
                    $query="SELECT resources.*,option_tbl.course,reg_opttbl.uid,reg_opttbl.course_code from resources left join option_tbl on resources.course=option_tbl.id left join reg_opttbl on resources.course=reg_opttbl.id where re_id='$id'";
