             ...
             <div id="divLsn">
                 <div ID="dlLessons"  OnItemCommand="Item_Command">
                         ...
                         <div id="pricePlans" style="overflow: hidden">
                            ...
                            $verify = $db->query("SELECT * FROM `resources` where course='$VID' and level='$level' ");
                            while($row = mysqli_fetch_array($verify))
                          {
                           ...
                           ?>
                             ...
                             $data = $db->query("SELECT resources.*, option_tbl.course FROM resources LEFT JOIN option_tbl on resources.course=option_tbl.id where resources.re_id='$id'");
