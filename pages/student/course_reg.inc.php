                            ...
                            <div class="form-horizontal">
                                <fieldset>
                                    ...
                                    <div class="form-group" id="divRole">
                                      ...
                                      $result=mysqli_query($db,"SELECT coursetbl.*,course_select_tbl.deid FROM coursetbl LEFT JOIN course_select_tbl on coursetbl.cid =course_select_tbl.cid where course_select_tbl.deid='$deptStd' and course_select_tbl.levid='$level' ");
...
<!--                                             <a href="index.php" class="btn btn-danger">Exit</a>
 -->  <input type="submit" name="add" class="btn form-control btn-primary" value="Add" >
                 ...
                 <div class="col-md-6" style="text-align: center;">
                    <h3 style=" font-family: sans-serif; ">Registered Courses</h3>
                    <?php
                  $result1=mysqli_query($db,"SELECT course_reg_st.*,coursetbl.course FROM course_reg_st left join coursetbl
                    on course_reg_st.cid=coursetbl.cid where course_reg_st.uid='$uid'");
                          ?>
                      ...
                      <table class="table table-bordered">
                         ...
                         <tr style="color: #ffffff;">
                          ...
                          <?php endif;?>
                          <td><a href="course_reg.inc.php?id=<?php echo $row1['rid']?>">Delete</a></td>
                         </tr>
                     <?php
                     }
                   ?>
    ...
    <!-- delecting from the course_reg table -->
     <?php
      if(isset($_GET['id'])){
        $id=$_GET['id'];
        mysqli_query($db,"DELETE FROM course_reg_st where rid='$id'");
