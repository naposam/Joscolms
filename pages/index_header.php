    ...
    $dept=$_SESSION['dept'];
        ...
        <nav class="navbar navbar-default top-navbar" role="navigation" style="background:url(img/colorful.jpg);">
            <div class="navbar-header">
                ...
                <a class="navbar-brand waves-effect waves-dark" href="index.php"><i class="large material-icons">JOSCO LMS</i> <strong></strong></a>
...
<li><a href="change_course.inc.php"><i class="fa fa-gear fa-fw"></i> Switch</a>
</li>
