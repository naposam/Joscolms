                ...
                <div class="Absolute-Center is-Responsive">
                 ...
                 <div class = "panel-body">
                                    ...
                                    <div class="form-group" id="divRole">
                                        ...
                                        <div class=" col-md-12">
                                           ...
                                           <div class="col-lg-10 col-lg-offset-1">
                                               ...
                                               <a href="main.php" class="btn btn-danger"><i class="fa fa-arrow-right"></i></a>
                    ...
                    <div class="col-sm-6 col-lg-6 col-md-6">
                        <?php  $result=mysqli_query($db,"SELECT coursetbl.course,course_reg.cid,course_reg.status,course_reg.uid FROM coursetbl LEFT JOIN course_reg ON coursetbl.cid = course_reg.cid WHERE course_reg.uid = '$uid' ");
 ?>
                         ...
                         while ($row=mysqli_fetch_array($result)){
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th></th>
                                    <?php if($status==='0'):?>
                                    <th><a href="course.php?uid=<?php echo $uid ?>" class="btn-primary" >Confirm</a></th>
                                <?php endif; ?>
                                </tr>
                            </tfoot>
                        </table>
