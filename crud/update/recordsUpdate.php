...
<body >
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50" style="background-image: url(../../img/colorful.jpg);">
        <div class="wrapper wrapper--w790">
            ...
            <img  class="direct-chat-img" src="../../resources/<?php echo $row["image"]?>" width="100" height="100">
            <?php if($row['status']=='1'):?> 
                 <span style="color: darkblue;font-style: italic;">Online</span>
             <?php endif;?>
             <?php if($row['status']=='0'):?> 
                ...
                <input type="hidden" name="user_id" value="<?php echo $row['user_id'];?>">
                    ...
                    <?php endif;?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="email" value="<?php echo $row['email'];?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                    ...
                    <?php endif;?>
                      ...
                      <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="password" name="passsword" value="<?php echo $row['passsword'];?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="../view_Teacher_inc.php" style="color: red;">Exit</a>
                        </div>
